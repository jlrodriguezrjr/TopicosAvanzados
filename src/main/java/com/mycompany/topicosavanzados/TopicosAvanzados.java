...
public class TopicosAvanzados implements ActionListener, KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (keyCode == KeyEvent.VK_DELETE) {
            String text = campoDeTexto.getText();
            if (text.length() > 0) {
                campoDeTexto.setText(text.substring(0, text.length() - 1));
            }
